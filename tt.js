            ...
            <div className="container h-full flex items-center justify-center w-full">
                ...
                >
                    <div className="main-content flex rounded-[20px] overflow-hidden w-full">
                        <div
                            className="left lg:w-1/2 sm:w-2/5 max-sm:hidden bg-[#fc8934] flex flex-col items-center justify-center gap-5 py-14">
                                ...
                                {products.slice(0, 4).map((item, index) => (
                                    <div key={index}>
                                        ...
                                        >
                                            ...
                                            <button
                                                className="quick-view-btn button-main sm:py-3 py-2 sm:px-5 px-4 bg-[#fc8934] text-white rounded-full whitespace-nowrap"
